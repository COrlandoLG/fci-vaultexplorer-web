...
EnumDescriptions.set(BooleanEnum, new Map<number, string>([
	[BooleanEnum.NO, "No"],
	[BooleanEnum.YES, "Yes"]
]));
...
EnumDescriptions.set(LoanStatusForFCIWebEnum, new Map<number, string>([
...
EnumDescriptions.set(PriorityEnum, new Map<number, string>([
...
EnumDescriptions.set(NoteTypeEnum, new Map<number, string>([
...
EnumDescriptions.set(RateTypeEnum, new Map<number, string>([
